...
#iv = urandom(AES.block_size)  # Random IV
...
cipher_python = encrypt_with_AES(plain_text, secret_key, salt)
print(f"Cipher: {cipher_python}")

# Java -> Python
cipher_java = "aXYgdGVzdGFuZG8gYWFhYRRO0ZrUeiu6MfAGTd4YJGQmCGYdTO4hig9I4pMpl1dK"
decrypted = decrypt_with_AES(cipher_java, secret_key, salt)
